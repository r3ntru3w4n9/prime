...
public:
    ...
    bool routable(const unsigned a) const override { return false; }
    int get_cost() const override { return _cost; }
    void assign_estimated(unsigned pi,int c) override { _pi = pi; _cost = c; }//this is for virtual convenience
    unsigned get_target() const override { return _pi; }//should be get_pi, but for virtual convenience
    void reset() override { return; }

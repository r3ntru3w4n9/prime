...
public:
    MyComp() {}
    bool operator() (const Grid* lhs, const Grid* rhs) const { return ((lhs->get_estimated())>(rhs->get_estimated())); }
};
...
public:
    ...
    unsigned get_idx(unsigned x, unsigned y, unsigned z) const { return z*_area+y*_x+x; }
